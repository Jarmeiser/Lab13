...
public class OvalTestOfficial
{
    ...
    public void testOvalConstructorPoint()
    {
        ...
        // TODO: implement this.
        Assert.assertEquals("Location of Oval is correct", new Point(75, 75), o1.location[0]);
        Assert.assertEquals("Location of Oval is correct", new Point(63, 63), o2.location[0]);
        Assert.assertEquals("Location of Circle is correct", new Point(170, 270), c1.location[0]);
        Assert.assertEquals("Location of Circle is correct", new Point(163, 263), c2.location[0]);
